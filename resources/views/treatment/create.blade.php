...
@section('content')
    <main>
        <div class="form-card">
            ...
            <form action="{{ route('treatments.store') }}" method="POST" class="form-container">
                @csrf
                ...
                <div class="form-row">
                    <div class="form-col">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="treatment_date" id="reg-date" value="{{ old('treatment_date') }}" required>
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <input type="number" name="treatment_cost" step="0.01" min="0" id="cost" value="{{ old('treatment_cost') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="treatment_procedure" id="treatment" value="{{ old('treatment_procedure') }}" maxlength="300" placeholder="Enter Treatment Procedure.." required>
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <select name="treatment_status" id="related-TreatmentStatus" required>
                                ...
                                <option value="{{ $status }}" {{ old('treatment_status') == $status ? 'selected' : '' }}>{{ ucfirst($status) }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            ...
                            <select name="treatment_type" id="related-TreatmentType">
                                ...
                                <option value="{{ $type }}" {{ old('treatment_type') == $type ? 'selected' : '' }}>{{ $type }}</option>
                                @endforeach
                            </select>
