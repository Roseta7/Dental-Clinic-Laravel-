...
@section('content')
    ...
    <main>
        <div class="form-card">
            ...
            <form action="{{ route('appointments.update', $appointment->id) }}" method="POST" class="form-container">
                @csrf
                @method('PUT')
                ...
                <div class="form-row">
                    <div class="form-col">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="appointment_date" id="reg-date" value="{{ old('appointment_date', $appointment->appointment_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="0" name="appointment_cost" step="0.01" id="cost" value="{{ old('appointment_cost', $appointment->appointment_cost) }}" required>
                    ...
                    <div class="form-col">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="time" name="appointment_time" value="{{ old('appointment_time', $appointment->appointment_time) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="appointment_status" id="status" class="required">
                                ...
                                @foreach(['upcoming','in-progress','completed','cancelled','rescheduled'] as $status)
                                    <option value="{{ $status }}" {{ old('appointment_status', $appointment->appointment_status) == $status ? 'selected' : '' }}>
                                        {{ ucfirst($status) }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="visit_type" id="status" class="required">
                                ...
                                @foreach(['checkup','emergency','consultation','follow_up','treatment'] as $type)
                                    <option value="{{ $type }}" {{ old('visit_type', $appointment->visit_type) == $type ? 'selected' : '' }}>
                                        {{ ucfirst($type) }}
                                    </option>
                                @endforeach
                            </select>
