...
class MedicalHistoryPolicy
{
    ...
    {
        return $user->hasPermissionTo('view medical histories');
    }
    ...
    {
        return $user->hasPermissionTo('create medical histories');
    }
    ...
    {
        return $user->hasPermissionTo('edit medical histories');
    }
    ...
    {
        return $user->hasPermissionTo('delete medical histories');
    }
